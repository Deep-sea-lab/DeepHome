...
export default function Page() {
	...
	return (
		<>
			...
			<Card className='static p-4' staticLayout>
				<div className='flex flex-wrap items-center justify-between gap-3'>
					<div>
						...
						<p className='text-secondary mt-1 text-sm'>上传、删除首页轮播图片。</p>
					</div>
			...
			<RandomLayout pictures={pictures} isEditMode={true} onDeleteSingle={handleDeleteSingleImage} onDeleteGroup={handleDeleteGroup} />

			{pictures.length === 0 && (
				<div className='text-secondary flex min-h-[300px] items-center justify-center text-center text-sm'>还没有上传图片。</div>
			)}
